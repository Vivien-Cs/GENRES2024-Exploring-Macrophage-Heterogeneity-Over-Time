...
seurat_merged$condition_time <- factor(seurat_merged$condition_time, 
                                       levels = c("Media_48_Li_2019_zero","Media_M0_Hagai_2018_zero",
...
saveRDS(seurat_integrated_standard, file = paste0(output_integrated, "seurat_integrated_no_trapnell.rds"))  
...
# Save integrated object
saveRDS(seurat_integrated_genelist, file = paste0(output_integrated, "seurat_integrated_amdsg_psg_no_trapnell.rds"))
##################################
##################################
##################################
