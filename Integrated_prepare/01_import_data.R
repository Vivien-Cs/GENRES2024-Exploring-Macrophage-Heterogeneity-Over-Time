...
# Define the samples, corresponding time points, and conditions for Liu et al
...
exp_path <- paste0(base_path,"/data_raw/GSE158094_RAW/")
...
for (sample in 1:length(lstSamples)){
  data_dir <- paste0(exp_path, lstConditions[[sample]] ,"/", lstTime[[sample]], "/" )
...
lstConditions_48h <- c("Media_48_Li_2019", "M1_LPS_IFNG_48_Li_2019") 
